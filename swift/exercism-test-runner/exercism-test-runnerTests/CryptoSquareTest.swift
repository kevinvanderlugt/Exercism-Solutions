...
class CryptoSquareTest: XCTestCase {
    ...
    func test_empty_characters() {
        var crypto = Crypto("")
        XCTAssertEqual("", crypto.normalizePlaintext )
    }

    func test_size_of_empty_characters() {
        var crypto = Crypto("")
        XCTAssertEqual(0, crypto.size )
    }

    func test_plaintestSegments_empty_message() {
        var crypto = Crypto("")
        XCTAssertEqual([], crypto.plaintextSegments )
    }
